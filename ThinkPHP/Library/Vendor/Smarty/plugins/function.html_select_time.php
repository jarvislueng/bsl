...
function smarty_function_html_select_time($params, $template) {
    ...
    if ($display_hours) {
        ...
        for($i = $start; $i <= $end; $i ++) {
            ...
            $_html_hours .= '<option value="' . $_value . '"' . ($selected ? ' selected="selected"' : '') . '>' . $_text . '</option>' .
                 $option_separator;
        }
    ...
    if ($display_minutes) {
        ...
        for($i = 0; $i <= 59; $i += $minute_interval) {
            ...
            $_html_minutes .= '<option value="' . $_value . '"' . ($selected === $i ? ' selected="selected"' : '') . '>' . $_text . '</option>' .
                 $option_separator;
        }
    ...
    if ($display_seconds) {
        ...
        for($i = 0; $i <= 59; $i += $second_interval) {
            ...
            $_html_seconds .= '<option value="' . $_value . '"' . ($selected === $i ? ' selected="selected"' : '') . '>' . $_text . '</option>' .
                 $option_separator;
        }
    ...
    if ($display_meridian && ! $use_24_hours) {
        ...
        $_html_meridian .= '<option value="am"' . ($_hour < 12 ? ' selected="selected"' : '') . '>AM</option>' . $option_separator .
             '<option value="pm"' . ($_hour < 12 ? '' : ' selected="selected"') . '>PM</option>' . $option_separator . '</select>';
    }
