...
abstract class Smarty_Internal_TemplateCompilerBase {
                ...
                if (isset($this->smarty->registered_objects[$base_tag]) && isset($parameter['object_methode'])) {
                    ...
                    if (in_array($methode, $this->smarty->registered_objects[$base_tag][3])) {
                        ...
                        return $this->trigger_template_error(
                            'unallowed closing tag methode "' . $methode . '" in registered object "' . $base_tag . '"', $this->lex->taglineno);
                    }
                }
    ...
    public function trigger_template_error($args = null, $line = null) {
        ...
        $match = preg_split("/\n/", $this->lex->data);
        $error_text = 'Syntax Error in template "' . $this->template->source->filepath . '"  on line ' . $line . ' "' .
