    ...
    public function getContent(Smarty_Template_Source $source) {
        ...
        foreach ($_components as $_component) {
            ...
            if ($_component != $_last) {
                ...
                preg_match_all("!{$_ldl}block\s(.+?){$_rdl}|{$_ldl}/block{$_rdl}|{$_ldl}\*([\S\s]*?)\*{$_rdl}!", $_content, $_result, 
                    PREG_OFFSET_CAPTURE);
                ...
                while ( $_start + 1 < $_result_count ) {
                    ...
                    while ( $_level != 0 ) {
                        $_end ++;
                        if (substr($_result[0][$_start + $_end][0], 0, strlen($source->smarty->left_delimiter) + 1) ==
