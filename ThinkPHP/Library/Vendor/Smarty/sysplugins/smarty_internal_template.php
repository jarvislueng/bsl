...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase {
    ...
    public function mustCompile() {
        ...
        if ($this->mustCompile === null) {
            $this->mustCompile = (! $this->source->uncompiled && ($this->smarty->force_compile || $this->source->recompiled ||
                 $this->compiled->timestamp === false || ($this->smarty->compile_check && $this->compiled->timestamp < $this->source->timestamp)));
        }
    ...
    public function createTemplateCodeFrame($content = '', $cache = false) {
        ...
        if ($cache) {
            ...
            if (! empty($this->smarty->template_functions)) {
                ...
                foreach ($this->smarty->template_functions as $name=>$function_data) {
                    if (isset($function_data['called_nocache'])) {
                        unset($function_data['called_nocache'], $function_data['called_functions'], 
        ...
        if (! $this->source->recompiled) {
            $output .= '<?php if ($_valid && !is_callable(\'' . $this->properties['unifunc'] . '\')) {function ' . $this->properties['unifunc'] .
                 '($_smarty_tpl) {?>';
        }
    ...
    public function __get($property_name) {
        switch ($property_name) {
            ...
            case 'compiler' :
                ...
                $this->compiler = new $this->source->compiler_class($this->source->template_lexer_class, $this->source->template_parser_class, 
                    $this->smarty);
