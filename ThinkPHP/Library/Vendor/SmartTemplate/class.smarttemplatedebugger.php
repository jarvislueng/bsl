...
class SmartTemplateDebugger {
    ...
    function toggleview($suffix = '') {
        ...
        $ret = '[' . $suffix . '<a href="javascript:void(\'\');" onclick="toggleVisibility(document.getElementById(\'Block' . $spancnt .
             '\'), this); return false">Hide Block</a>]<span id="Block' . $spancnt . '" style="display:block">';
        return $ret;
    }
