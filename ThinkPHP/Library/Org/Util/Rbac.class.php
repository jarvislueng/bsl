...
class Rbac {
    ...
    static public function getAccessList($authId) {
        ...
        $sql = "select node.id,node.name from " . $table['role'] . " as role," . $table['user'] . " as user," . $table['access'] . " as access ," .
             $table['node'] . " as node " .
        ...
        foreach ($apps as $key=>$app) {
            ...
            foreach ($modules as $key=>$module) {
                ...
                if ('PUBLIC' == strtoupper($moduleName)) {
                    $sql = "select node.id,node.name from " . $table['role'] . " as role," . $table['user'] . " as user," . $table['access'] .
    ...
    static public function getModuleAccessList($authId, $module) {
        ...
        $sql = "select access.node_id from " . $table['role'] . " as role," . $table['user'] . " as user," . $table['access'] . " as access " .
